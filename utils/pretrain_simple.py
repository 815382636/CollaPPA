...
from utils.utils import ExpDataLoader, SeqDataLoader, AllBatchify, ExpBatchify, SeqBatchify, TopNBatchify, now_time, ReaBatchify, RLSeqBatchify
...
parser.add_argument('--checkpoint', type=str, default='./single/',
...
all_iterator = RLSeqBatchify(seq_corpus.user2items_positive, tokenizer, args.batch_size)
